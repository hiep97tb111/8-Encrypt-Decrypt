...
class MainAct : AppCompatActivity() {
    ...
    private fun handleEncryptAES256ModeCBC(plainText: String, encryptionKey: String) {
        ...
        handleDencryptAES256ModeCBC(Base64.encodeToString(combinedBytes, Base64.DEFAULT), encryptionKey
        )
    }

    private fun handleDencryptAES256ModeCBC(encryptedText: String?, encryptionKey: String) {
